...
public class ENPush: NSObject {
    ...
    public enum Region: String {
        ...
        case sydney = "au-syd"
         ...
         /**
         The Frankfurt IBM Cloud region.
         */
        case frankfurt = "eu-de"

        /**
        The Madrid IBM Cloud region.
        */
        case madrid = "eu-es"
        ...
        */
        ...
        /**
        The Toronto IBM Cloud region.
        */
        case toronto = "ca-tor"
        
        /**
        The Tokyo IBM Cloud region.
        */
        case tokyo = "jp-tok"
        
        /**
        The Osaka IBM Cloud region.
        */
        case osaka = "jp-osa"
        
        /**
        The Sao Paulo IBM Cloud region.
        */
        case saopaulo = "br-sao"

        /**
        The Montreal IBM Cloud region.
        */
...
//                guard response != nil, let statusCode = response?.statusCode else {
    ...
    fileprivate func checkStatusChange() {
        ...
        if UserDefaults.standard.object(forKey: ENPUSH_APP_INSTALL) != nil {
            ...
            UserDefaults.standard.synchronize()
            NotificationCenter.default.addObserver(forName: enNotificationName, object: nil, queue: OperationQueue.main) { _ in
