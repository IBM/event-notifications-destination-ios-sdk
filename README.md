...
# iOS destination SDK for IBM Cloud Event Notifications service Version 0.0.6
...
--- | ---
[Event Notifications Service](https://cloud.ibm.com/apidocs/event-notifications) | ENPushDestination:0.0.6
...
```ruby
  github "IBM/event-notifications-destination-ios-sdk" ~> 0.0.6
```
...
```ruby
dependencies: [
    .package(url: "https://github.com/IBM/event-notifications-destination-ios-sdk", from: "0.0.6")
]
```
