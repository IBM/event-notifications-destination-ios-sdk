...
2. Initialize the ENPushDestination SDK
	...
	- region : Region of the Event Notifications Instance. eg; `Region.usSouth`, `Region.london`, `Region.sydney`, `Region.frankfurt`, `Region.madrid`, `Region.bnpp`, `Region.toronto`, `Region.tokyo`, `Region.osaka`, `Region.saopaulo`, `Region.montreal`, `Region.washingtonDC`, `Region.chennai`
